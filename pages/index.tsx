...
export default function Home() {
  ...
  return (
    <div className="flex overflow-hidden min-h-screen bg-secondary">
      {gettingLocation && (
        <h2 className="text-secondary">Getting Location...</h2>
      )}
      {!gettingLocation && (
        /* <Sidebar /> */
        /* <Topbar /> */
          ...
          <div className="flex flex-col mt-24 p-4 w-full max-w-5xl gap-5">
            ...
            <div className="flex flex-col w-full">
              ...
              <button
                ...
                className="mt-4 text-tertiary bg-gray-100 hover:bg-tertiary disabled:bg-secondary focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-8 py-2.5 text-center mr-2 mb-2 shadow-xl"
                onClick={e => {
                  e.preventDefault()
                  if (location) {
